                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加更多问题信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=question&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addquestion.js"></script>';
?>
