...
<?php include VIEWPATH . 'header.php' ?>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>前端通知列表</div>
  ...
  <!--                                      <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=qtnotify&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_qtnotify_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_qtnotify_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">发邮件地址</th>
                                            <th class="hidden-480">发通知部门</th>
                                            <th class="hidden-480">通知标题</th>
                                            <th class="hidden-480">通知时间</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showqtnotify.js"></script>';
?>
