                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>问候语列表</div>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=greetings&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_greetings_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_greetings_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">问候语内容</th>
                                            <th class="hidden-480">字体颜色</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showgreetings.js"></script>';
?>
