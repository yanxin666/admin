                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加组织机构信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=org&m=insert" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="order_id" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="old_exits_id" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addorg.js"></script>';
?>
