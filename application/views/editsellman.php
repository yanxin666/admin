                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改销售组员信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=sellman&m=update" method="POST" id="form_sample_2" class="form-horizontal">
									<input type="hidden" name="orgstrid" value="<?php echo $sellman['orgstrid'] ?>"/>
									<input type="hidden" name="olduserid" id="olduserid" value="<?php echo $sellman['user_id'] ?>"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="user_id" id="newuserid" value="<?php echo $sellman['user_id'] ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="user_name" value="<?php echo $sellman['user_name'] ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="user_sn" value="<?php echo $sellman['user_sn'] ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
									...
									<div class="control-group">
										...
										<div class="controls chzn-controls">
											<select id="form_2_chosen" class="span6 chosen" data-with-diselect="1" name="role_id" data-placeholder="选择角色" tabindex="1">
												...
												?>
												<option value="<?php echo $k ?>" <?php if($k == $sellman['role_id']) echo "selected" ?>><?php echo $v ?></option>
												<?php }?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="orgstr_id" value="<?php echo $sellman['orgstr_id'] ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="orgstr_tree" data-required="1" class="span6 m-wrap"><?php echo $sellman['orgstr_tree'] ?></textarea>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editsellman.js"></script>';
?>
