                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=menu&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_menu_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_menu_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">菜单名称</th>
                                            <th class="hidden-480">父菜单id</th>
                                            <th class="hidden-480">菜单别名</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showmenu.js"></script>';
?>
