                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>联系组列表</div>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=team&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_team_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_team_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showteam.js"></script>';
?>
