                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加版本信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=version&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
										<label class="control-label">平台:<span class="required">*</span></label>
												<div class="controls chzn-controls">
													<select id="form_2_chosen" class="span6 chosen" data-with-diselect="1" name="plat_form" data-placeholder="选择平台" tabindex="1">
														<option value=""></option>
														<?php
															foreach ($plat_form as $k=>$v){
														?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="version" name="version" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label">版本更新下载地址<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="downloadurl" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label">设置为当前版本<span class="required">*</span></label>
                                        <div class="controls">
                                            <input class="checkboxes" type="checkbox" name="status" value="1">
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addversion.js"></script>';
?>
