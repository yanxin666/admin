                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>轮播图列表</div>
...
<!--                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=slide&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_slide_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_slide_1 .checkboxes" />
                                            </th>
                                            <th class="hidden-480">序号</th>
                                            <th>ID</th>
                                            <th class="hidden-480">轮播图标题</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showslide.js"></script>';
?>
