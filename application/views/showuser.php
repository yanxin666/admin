                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <!--<button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=user&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_user_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_user_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">用户名</th>
                                            <th class="hidden-480">员工编号</th>
                                            <th class="hidden-480">员工全称</th>
                                            <th class="hidden-480">座机电话</th>
                                            <th class="hidden-480">手机号码</th>
                                            <th class="hidden-480">职务</th>
                                            <th class="hidden-480">状态</th>
                                            <th class="hidden-480">后台权限</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showuser.js"></script>';
?>
