                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>销售组员列表</div>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=sellman&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_sellman_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_sellman_1 .checkboxes" />
                                            </th>
                                            <th>主键ID</th>
                                            <th class="hidden-480">组员id</th>
                                            <th class="hidden-480">组员名称</th>
                                            <th class="hidden-480">组员工号</th>
                                            <th class="hidden-480">角色</th>
                                            <th class="hidden-480">角色id</th>
                                            <th class="hidden-480">组织架构id</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showsellman.js"></script>';
?>
