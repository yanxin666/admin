                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>组织机构列表</div>
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=org&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_org_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_org_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">父id</th>
                                            <th class="hidden-480">部门信息名称</th>
                                            <th class="hidden-480">父id范围</th>
                                            <th class="hidden-480">顺序id</th>
                                            <th class="hidden-480">等级</th>
                                            <th class="hidden-480">部门信息编号</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showorg.js"></script>';
?>
