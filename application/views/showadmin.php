                            ...
                            <div class="portlet-body">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=admin&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_admin_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_admin_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">管理员邮箱</th>
                                            <th class="hidden-480">所属部门</th>
                                            <th class="hidden-480">发通知权限</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showadmin.js"></script>';
?>
