...
<?php include VIEWPATH . 'header.php' ?>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>前端联系组列表</div>
 ...
 <!--                                       <button id="sample_editable_1_new" class="btn green" onClick='location="/index.php?c=qtteam&m=add"'>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_qtteam_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_qtteam_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
                                            <th class="hidden-480">组名称</th>
                                            <th class="hidden-480">组创建人</th>
                                            <th class="hidden-480">组类型</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showqtteam.js"></script>';
?>
