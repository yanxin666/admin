                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-globe"></i>人事通知详情列表</div>
...
<!--                                     </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_rsnotifydetails_1">

                                    <thead>
                                        <tr>
                                            <th style="width:8px;">
                                                <input type="checkbox" class="group-checkable" data-set="#sample_rsnotifydetails_1 .checkboxes" />
                                            </th>
                                            <th>ID</th>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/showrsnotify_details.js"></script>';
?>
