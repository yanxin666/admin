                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改使用帮助信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=usehelp&m=update" method="POST" id="form_sample_2" class="form-horizontal">
									<input type="hidden" name="id" value="<?php echo $usehelp['id']; ?>">
									<input type="hidden" name="oldtitle" id="oldtitle" value="<?php echo $usehelp['title']; ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" id="newtitle" value="<?php echo $usehelp['title']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="content" data-required="1" class="span6 m-wrap"><?php echo $usehelp['content']; ?></textarea>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editusehelp.js"></script>';
?>
