                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加考勤信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=kaoqin&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append date form_meridian_datetime" data-date="2015-09-02T15:25:00Z">
												<input size="16" type="text" value="" readonly class="m-wrap" name="kqtime">
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="latitude" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="longtitude" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addkaoqin.js"></script>';
?>
