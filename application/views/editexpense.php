                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改报销信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=expense&m=update" method="POST" id="form_sample_2" class="form-horizontal">
									<input type="hidden" name="id" value="<?php echo $expense['id']; ?>"/>
									<input type="hidden" name="oldcode" id="oldcode" value="<?php echo $expense['expense_code']; ?>"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="expense_code" id="newcode" value="<?php echo $expense['expense_code']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="gz_no" value="<?php echo $expense['gz_no']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
										...
										<label class="control-label">申请人:<span class="required">*</span></label>
												<div class="controls chzn-controls">
													<select id="form_2_chosen" class="span6 chosen" data-with-diselect="1" name="author_user" data-placeholder="选择申请人" tabindex="1">
														...
														?>
														<option value="<?php echo $data['id']?>" <?php if($data['id'] == $expense['author_user']) echo "selected"; ?>><?php echo $data['fullname']?></option>
														<?php }?>
													</select>
												</div>
									</div>
												...
												<div class="controls chzn-controls">
													<select id="form_3_chosen" class="span6 chosen" data-with-diselect="1" name="author_dept" data-placeholder="选择部门" tabindex="1">
														...
														<?php
															foreach ($org as $data){
														?>
														<option value="<?php echo $data['id']?>" <?php if($data['id'] == $expense['author_dept']) echo "selected"; ?>><?php echo $data['depart_name']?></option>
														<?php }?>
													</select>
												</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append date form_meridian_datetime" data-date="2015-09-02T15:25:00Z">
												<input size="16" type="text" value="<?php echo $expense['draft_time']; ?>" readonly class="m-wrap" name="draft_time">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="total_expense" value="<?php echo $expense['total_expense']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="had_act_user" value="<?php echo $expense['had_act_user']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
												...
												<div class="controls chzn-controls">
													<select id="form_4_chosen" class="span6 chosen" data-with-diselect="1" name="budget_year" data-placeholder="选择年份" tabindex="1">
														...
														<?php
															for($i=2000;$i<3000;$i++){
														?>
														<option value="<?php echo $i; ?>" <?php if($i == $expense['budget_year']) echo "selected"; ?>><?php echo $i;?></option>
														<?php }?>
													</select>
												</div>
									</div>
												...
												<div class="controls chzn-controls">
													<select id="form_5_chosen" class="span6 chosen" data-with-diselect="1" name="budget_month" data-placeholder="选择月份" tabindex="1">
														...
														<?php
															for($i=1;$i<13;$i++){
														?>
														<option value="<?php echo $i; ?>" <?php if($i == $expense['budget_month']) echo "selected"; ?>><?php echo $i;?></option>
														<?php }?>
													</select>
												</div>
									</div><br/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio line">
                                                <input type="radio" name="activityos" value="1" <?php if($expense['activityos'] == 1) echo "checked"; ?>/>待审批
                                            </label>
                                            <label class="radio line">
                                                <input type="radio" name="activityos" value="2" <?php if($expense['activityos'] == 2) echo "checked"; ?>/>已审批
                                            </label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio line">
                                                <input type="radio" name="islk" value="1" <?php if($expense['islk'] == 1) echo "checked"; ?>/>未领取
                                            </label>
                                            <label class="radio line">
                                                <input type="radio" name="islk" value="2" <?php if($expense['islk'] == 2) echo "checked"; ?>/>已领取
                                            </label>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editexpense.js"></script>';
?>
