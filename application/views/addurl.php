                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加网址推荐信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=url&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="url" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addurl.js"></script>';
?>
