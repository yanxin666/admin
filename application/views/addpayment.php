                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加薪酬密码信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=payment&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="email" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" name="password" data-required="1" class="span6 m-wrap" id="password"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" name="repassword" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addpayment.js"></script>';
?>
