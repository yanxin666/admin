                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加班车线路信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=bus&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="linename" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="line" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="linetime" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="driver" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="dmobile" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="busnumber" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="teamer" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="tmobile" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="temail" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    <!--<div class="controls">
                                    ...
                                    <div class="control-group" id="reference">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6 m-wrap" style="width:80px;height:20px;" name="get_station[]" onFocus="if(value=='上车站点'){value='';}" value="上车站点" data-required="1"/>&nbsp;
                                            <input type="text" class="span6 m-wrap" style="width:80px;height:20px;" name="send_time[]" onFocus="if(value=='发车时间'){value='';}" value="发车时间" data-required="1"/>&nbsp;
                                            <input type="text" class="span6 m-wrap" style="width:210px;height:20px;" name="stop_address[]" onFocus="if(value=='停车位置'){value='';}" value="停车位置" data-required="1"/>
                                        </div><br/>
                                    </div>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="nightstart" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="nighttime" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="nightadd" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addbus.js"></script>';
?>
