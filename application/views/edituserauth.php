                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改用户权限信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=userauth&m=update" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
									<input type="hidden" name="id" value="<?php echo $userauth['id']; ?>"/>
									<input type="hidden" id="olduserid" value="<?php echo $userauth['userid'] ?>">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls chzn-controls">
											<select id="form_2_chosen" class="span6 chosen" data-with-diselect="1" name="userid" data-placeholder="选择用户" tabindex="1">
												...
												?>
												<option value="<?php echo $data['id']?>" <?php if($data['id'] == $userauth['userid']) echo "selected"; ?>><?php echo $data['fullname']?></option>
												<?php }?>
											</select>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls" style="margin-top:5px;">
											...
											?>
											<input class="checkboxes" type="checkbox" name="auth[]" value="<?php echo $data['cname']?>" <?php if(in_array($data['cname'],$userauth['auth'])) echo "checked"; ?>><?php echo $data['cname']?>												
											<?php }?>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/edituserauth.js"></script>';
?>
