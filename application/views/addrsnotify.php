                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加人事通知信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=rsnotify&m=insert" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="target_address" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="sender_address" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
<!-- 														?> -->
<!-- 														<option value="<php echo $data['id'].'@'.$data['depart_name']; ?>"><php echo $data['fullname']?></option> -->
<!-- 														<php }?> -->
<!-- 													</select> -->
<!-- 												</div> -->
<!-- 									</div> -->
									...
									<div class="control-group">
                                        <label class="control-label">发通知人<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="sender_id" value="<?php echo $_SESSION['loginInfo']['loginname']; ?>" disabled data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="device" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
<!--                                         <div class="controls"> -->
<!--                                             <label class="radio line"> -->
<!--                                                 <input type="radio" name="state" value="1"/>发送 -->
<!--                                             </label> -->
<!--                                             <label class="radio line"> -->
<!--                                                 <input type="radio" name="state" value="2" disabled />已发送 -->
<!--                                             </label> -->
<!--                                             <label class="radio line"> -->
<!--                                                 <input type="radio" name="state" value="3" disabled/>已接收 -->
<!--                                             </label> -->
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addrsnotify.js"></script>';
?>
