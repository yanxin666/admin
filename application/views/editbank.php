                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改发卡行信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=bank&m=update" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
									<input type="hidden" name="id" value="<?php echo $bank['id']; ?>"/>
									<input type="hidden" name="oldname" id="oldname" value="<?php echo $bank['name']; ?>"/>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">发卡行名称<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="name" id="newname" value="<?php echo $bank['name']; ?>" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editbank.js"></script>';
?>
