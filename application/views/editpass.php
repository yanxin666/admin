                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改管理员密码</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=admin&m=updatepass" method="POST" id="form_sample_2" class="form-horizontal">
                                     <input type = "hidden" name = "id" value = "<?php echo is_numeric($admin_data["id"]) ? intval($admin_data["id"]) : ""; ?>"/>
                                    <input type = "hidden" name = "oldpass" value = "<?php echo trim($admin_data["password"]) ? trim($admin_data["password"]) : ""; ?>" id="oldpass"/>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editpassword.js"></script>';
?>
