                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>添加联系组信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=team&m=insert" method="POST" id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="team_name" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
...
<!--                                         <div class="controls"> -->
<!--                                             <input type="text" name="team_mails" data-required="1" class="span6 m-wrap"/> -->
<!--                                         </div> -->
<!--                                     </div> -->
...
<!--                                                 <input type="radio" name="type" value="1" disabled/>默认组 -->
<!--                                             </label> -->
<!--                                             <label class="radio line"> -->
<!--                                                 <input type="radio" name="type" value="2" />邮件组 -->
<!--                                             </label> -->
<!--                                             <label class="radio line"> -->
<!--                                                 <input type="radio" name="type" value="3" disabled/>自定义组 -->
<!--                                             </label> -->
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/addteam.js"></script>';
?>
