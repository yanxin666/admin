                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改乐居菜单信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=appmenu&m=update" method="POST" id="form_sample_2" class="form-horizontal">
									<input type="hidden" name="id" value="<?php echo $appmenu['id']; ?>"/>
									<input type="hidden" name="oldtitle" id="oldtitle" value="<?php echo $appmenu['title']; ?>"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" readonly value="<?php echo $appmenu['title']; ?>" id="newtitle" data-required="1" class="span6 m-wrap"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group quanxian">
                                        ...
                                        <div class="controls">
                                            <label class="radio line">
                                                <input type="radio" name="status" value="1" <?php if($appmenu['status'] == 1) echo "checked"; ?>/>显示
                                            </label>
                                            <label class="radio line">
                                                <input type="radio" name="status" value="2" <?php if($appmenu['status'] == 2) echo "checked"; ?>/>隐藏
                                            </label>
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editappmenu.js"></script>';
?>
