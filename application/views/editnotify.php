                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>修改通知信息</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/index.php?c=notify&m=update" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
...
$js_include[] = '<script type="text/javascript" src="/js/webadmin/editnotify.js"></script>';
?>
