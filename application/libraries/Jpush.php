<?php	
class Jpush{
// 		private $app_key = '37971545ed94c261bc669d6a';            //待发送的应用程序(appKey)，只能填一个。
// 		private $master_secret = 'b63eb9d25f3ee61eab9c53c4';      //主密码
		private $app_key = '64e6cfd5391eae8e31adf9f6';            //待发送的应用程序(appKey)，只能填一个。
		private $master_secret = '7f1dddb74e07c79d3155d253';      //主密码
		...
		public function push($receiver='all',$content='',$m_type='',$m_txt='',$m_time='86400',$sendtype=''){
			...
			$data['notification'] = array(
					...
					"android"=>array(
							...
							"title"=>"",
							"builder_id"=>1,
							"extras"=>array("type"=>$m_type, "txt"=>$m_txt, "sendtype"=>$sendtype)
					),
					//ios的自定义
					"ios"=>array(
							// "alert"=>$content,
