jQuery(document).ready(function() {
    ...
    // begin first table
            ...
            jQuery('#sample_url_1 .group-checkable').change(function () {
     ...
     if(confirm('删除后无法恢复,确定要删除吗?') == true){
    	 $.ajax({
        	 ...
        	 success: function(data){
        		 if(data == 1){
        			 alert("删除成功");
        			 window.location.href="/index.php?c=url&m=index";
        		 }else{
        			 alert("删除失败");
        			 window.location.href="/index.php?c=url&m=index";
        		 }
