        ...
        form2.validate({
            ...
            rules: {
                userid: {
                    required: true,
                    remote: {
                    	url: "/index.php?c=userauth&m=checkedit",
                    	type: "post",
                    	dataType: "json",
                    	data: {
                    		olduserid: function(){
            ...
            errorPlacement: function (error, element) { // render error placement for each input type
                ...
                //} else 
				if (element.attr("name") == "auth[]") { // 统一的单选按钮,插入后给定的容器。比如：form_2_membership_error
                    error.addClass("no-left-padding111").insertAfter("#form_2_auth_error");
